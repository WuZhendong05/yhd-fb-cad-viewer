...
const WORKBENCH_BASE_THEME_SETTINGS = Object.freeze({
  ...
  // Workbench is a clean engineering canvas: no stage floor plane. The ground
  // grid and origin axis are available in the theme editor but default to off,
  // so a fresh session starts with only the model on canvas.
  floor: {
    ...CINEMATIC_THEME_SETTINGS.floor,
    color: WORKBENCH_LIGHT_FLOOR_COLOR,
    enabled: false,
    ...createFloorGridSettings(WORKBENCH_LIGHT_FLOOR_COLOR, { enabled: false, opacity: 0.16 }),
    ...createFloorAxisSettings(WORKBENCH_LIGHT_FLOOR_COLOR, { enabled: false, opacity: 0.28 })
  },
  environment: {
...
const WORKBENCH_DARK_THEME_SETTINGS = Object.freeze({
  ...
  floor: {
    ...
    ...createFloorGridSettings(WORKBENCH_DARK_FLOOR_COLOR, { enabled: false, opacity: 0.16 }),
    ...createFloorAxisSettings(WORKBENCH_DARK_FLOOR_COLOR, { enabled: false, opacity: 0.28 })
  },
  lighting: {
...
export const THEME_PRESETS = Object.freeze([
  {
    id: "workbench-light",
    label: "浅色工作台",
    description: "浅色画布上的均衡 CAD 工作台光照。",
    preview: {
      background: "#f0f4f9",
      modelColor: "#b6c4ce",
      accentColor: "#4ea7d8"
  ...
  },
  {
    id: "workbench-dark",
    label: "深色工作台",
    description: "深蓝灰画布上的均衡 CAD 工作台光照。",
    preview: {
      background: "#181f28",
      modelColor: "#b6c4ce",
      accentColor: "#4ea7d8"
  ...
  },
  {
    id: "cinematic",
    label: "电影感",
    description: "胶片级影棚布景，暖色主光、铜色点缀与光泽炭黑地面。",
    preview: {
  ...
  },
  {
    id: "pink",
    label: "洋红",
    description: "近黑舞台上的饱和洋红填充，配洋红轮廓光晕。",
    preview: {
  ...
  },
  {
    id: "clay-sunrise",
    label: "陶土",
    description: "缎面陶土舞台上的暖色陶土填充，配金色时段光线。",
    preview: {
  ...
  },
  {
    id: "terminal",
    label: "终端",
    description: "光泽黑舞台上的磷光绿线条，配绿色网格地面。",
    preview: {
