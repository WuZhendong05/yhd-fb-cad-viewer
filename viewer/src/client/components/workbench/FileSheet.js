...
export default function FileSheet({
  ...
  return (
    <aside
      className={cn(
        "cad-glass-surface pointer-events-auto z-30 flex h-full max-w-[calc(100vw_-_0.75rem)] flex-col text-sidebar-foreground",
    ...
    >
      {isDesktop && typeof onStartResize === "function" ? (
        <button
          ...
          className={cn(
            "group/file-sheet-resize absolute inset-y-0 z-30 flex h-auto w-3 cursor-col-resize touch-none items-stretch justify-center rounded-none px-0 py-0 hover:bg-transparent",
