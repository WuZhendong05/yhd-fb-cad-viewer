...
const PROJECTION_MODE_OPTIONS = [
  { value: CAMERA_PROJECTION.ORTHOGRAPHIC, label: "正交", title: "平行投影，适合 CAD 检查", Icon: OrthographicProjectionIcon },
  { value: CAMERA_PROJECTION.PERSPECTIVE, label: "透视", title: "带消失线的深度投影", Icon: PerspectiveProjectionIcon }
];


const PRIMARY_LIGHT_OPTIONS = [
  { value: "directional", label: "主光" },
  { value: "fill", label: "补光" },
  { value: "rim", label: "轮廓光" },
...
function ExplodedSliderRow({ displaySettings, updateDisplaySettings, explodeMeshData = null }) {
  ...
  return (
    <FileSheetSliderField
      ...
      valueInputProps={{ disabled: singlePart, ariaLabel: "爆炸程度" }}
    >
      <Slider
        className={precisionSliderClasses}
        value={[amount]}
  ...
  return (
    <div className="py-2" data-cad-theme-settings-section="true">
      ...
      <ControlSubsection title="渲染">
        ...
        />
        <SliderField label="色调映射" value={formatNumber(themeSettings.lighting.toneMappingExposure)}>
          <SliderInput
      ...
      <ControlSubsection title="表面">
        {themeSettings.materials.cycleColors === true ? (
          <Field label="颜色" value={`${resolveFillColors(themeSettings.materials).length}/${MAX_THEME_FILL_COLORS}`}>
            <FillColorEditor
        ...
        <SliderField label="粗糙度" value={formatNumber(themeSettings.materials.roughness)}>
          <SliderInput
        ...
        <SliderField label="金属度" value={formatNumber(themeSettings.materials.metalness)}>
          <SliderInput
        ...
        <SliderField label="清漆" value={formatNumber(themeSettings.materials.clearcoat)}>
          <SliderInput
        ...
        <SliderField label="反射" value={formatNumber(themeSettings.materials.envMapIntensity)}>
          <SliderInput
      ...
      <ControlSubsection title="调色">
        <SliderField label="饱和度" value={formatNumber(themeSettings.materials.saturation)}>
          <SliderInput
        ...
        <SliderField label="对比度" value={formatNumber(themeSettings.materials.contrast)}>
          <SliderInput
        ...
        <SliderField label="亮度" value={formatNumber(themeSettings.materials.brightness)}>
          <SliderInput
        ...
        {themeSettings.background.type === "linear" ? (
          <>
            ...
            <ColorModeField
              ...
              {...themeColorFieldProps}
            />
            <SliderField label="角度" value={`${formatNumber(themeSettings.background.linearAngle, 0)}°`}>
              <SliderInput
        ...
        {themeSettings.floor?.enabled === true ? (
          <>
            ...
            <ColorModeField
              ...
              {...themeColorFieldProps}
            />
            <SliderField label="粗糙度" value={formatNumber(themeSettings.floor?.roughness ?? 0.72)}>
              <SliderInput
            ...
            <SliderField label="反射率" value={formatNumber(themeSettings.floor?.reflectivity ?? 0.12)}>
              <SliderInput
            ...
            <SliderField label="阴影" value={formatNumber(themeSettings.floor?.shadowOpacity ?? 0.45)}>
              <SliderInput
            ...
            <SliderField label="背景混合" value={formatNumber(themeSettings.floor?.horizonBlend ?? 0)}>
              <SliderInput
        ...
        {themeSettings.floor?.grid?.enabled === true ? (
          <>
            ...
            <ColorModeField
              ...
              {...themeColorFieldProps}
            />
            <SliderField label="线条不透明度" value={formatNumber(themeSettings.floor?.grid?.opacity ?? 0.18)}>
              <SliderInput
            ...
            <SliderField label="密度" value={formatNumber(themeSettings.floor?.grid?.density ?? 1)}>
              <SliderInput
        ...
        {themeSettings.floor?.axis?.enabled === true ? (
          <>
            <ColorModeField
              ...
              {...themeColorFieldProps}
            />
            <SliderField label="轴不透明度" value={formatNumber(themeSettings.floor?.axis?.opacity ?? 0.5)}>
              <SliderInput
      ...
      >
        {themeSettings.environment.enabled ? (
          <>
            ...
            />
            <SliderField label="强度" value={formatNumber(themeSettings.environment.intensity)}>
              <SliderInput
      ...
      >
        ...
        {activePrimaryLightSettings.enabled ? (
          <>
            ...
            <SliderField label="强度" value={formatNumber(activePrimaryLightSettings.intensity)}>
              <SliderInput
            ...
            {activePrimaryLight === "spot" || activePrimaryLight === "point" ? (
              <SliderField label="距离" value={formatNumber(activePrimaryLightSettings.distance, 0)}>
                <SliderInput
            ...
            <SliderField label="高度（Y）" value={formatNumber(activePrimaryLightSettings.position.y, 0)}>
              <SliderInput
        ...
        {themeSettings.lighting.ambient.enabled ? (
          <>
            <ColorModeField
              ...
              {...themeColorFieldProps}
            />
            <SliderField label="强度" value={formatNumber(themeSettings.lighting.ambient.intensity)}>
              <SliderInput
        ...
        {themeSettings.lighting.hemisphere.enabled ? (
          <>
            ...
            <ColorModeField
              ...
              {...themeColorFieldProps}
            />
            <SliderField label="强度" value={formatNumber(themeSettings.lighting.hemisphere.intensity)}>
              <SliderInput
