...
function ExplorerViewSection({
  ...
  return (
    ...
    >
      <span className="min-w-0 truncate">在资源管理器中显示</span>
    </ContextMenuItem>
  );
}
  ...
  return (
    <>
      {canRevealFileAssets ? (
        ...
        >
          <span className="min-w-0 truncate">在文件夹中显示</span>
        </ContextMenuItem>
      ) : null}
      <ExplorerViewSection
        entry={entry}
      ...
      {canCopyFileAssetPaths && canCopyFileAssetReference ? (
        <>
          ...
          >
            <span className="min-w-0 truncate">复制文件名</span>
          </ContextMenuItem>
          <ContextMenuItem
            className="text-xs"
            onSelect={() => {
          ...
          >
            <span className="min-w-0 truncate">复制路径</span>
          </ContextMenuItem>
          <ContextMenuItem
            className="text-xs"
            onSelect={() => {
          ...
          >
            <span className="min-w-0 truncate">复制相对路径</span>
          </ContextMenuItem>
        </>
      ) : null}
      {canCopyFileAssetLinks && canCopyFileAssetReference ? (
        ...
        >
          <span className="min-w-0 truncate">复制链接</span>
        </ContextMenuItem>
      ) : null}
    </>
  );
