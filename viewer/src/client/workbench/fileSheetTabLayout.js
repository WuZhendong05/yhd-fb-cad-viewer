...
// (Feature tree + Tree on top; Reference/Display down in the bottom pane),
...
// Default split ratio: top pane takes 2/3, bottom 1/3 (2:1). Users can still
// drag the divider (resolved ratio overrides the default via localStorage).
export const DEFAULT_FILE_SHEET_SPLIT_RATIO = 2 / 3;
